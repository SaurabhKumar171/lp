        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;" >
                ...
                <tr>
                    ...
                    <center class="hero-section">
                    <table class="filter-container doctor-header patient-header hero-background" style="border: none;width:95%" border="0" >
                    <tr>
                        <td >
                            <h3>Welcome!</h3>
                            ...
                            <form action="schedule.php" method="post" style="display: flex" class="srch-form">
